...
const Sidebar: React.FC<SidebarProps> = ({ isVisible, onClose, onNavigate, isGuest = false }) => {
  ...
  const menuItems = [
    ...
    { icon: '📝', label: 'Data Entry', screen: 'DataEntry' },
    { icon: '⚠️', label: 'Alert Center', screen: 'AlertCenter' },
    { icon: '📲', label: 'SMS Simulator', screen: 'SmsSimulator' },
    { icon: '🦠', label: 'Health Archive', screen: 'Outbreaks' },
    { icon: '💧', label: 'Sensor Logs', screen: 'WaterQuality' },
    { icon: '🛡️', label: 'Awareness', screen: 'Awareness' },
